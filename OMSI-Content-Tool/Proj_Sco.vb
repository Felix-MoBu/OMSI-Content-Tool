...
Public Class Proj_Sco
    Public Const TYPE = Frm_Main.PROJ_TYPE_SCO
    ...
    Public splinehelpers As New List(Of splinehelper)
        ...
        If My.Computer.FileSystem.FileExists(filepath) Then
            ...
            For linect = 0 To allLines.Count - 1
                Select Case LCase(allLines(linect))
                    ...
                    Case "[boundingbox]"
                        bbox = New BoundingBox(toSingle(allLines(linect + 1)), toSingle(allLines(linect + 2)), toSingle(allLines(linect + 3)), toSingle(allLines(linect + 4)), toSingle(allLines(linect + 5)), toSingle(allLines(linect + 6)))
                    Case "[maplight]"
                    ...
                    Case "[tree]"
                        ...
                        linect += 5
                    Case "[splinehelper]"
                        Dim tmpHelper As New splinehelper
                        With tmpHelper
                                ...
                                If allLines(i) = "[traffic_light]" Then
                                    ...
                                    For n = i + 1 To allLines.Count - 1
                                        If allLines(n) = "[phase]" Then
                                            Dim newPhase As New traffic_light_phase
