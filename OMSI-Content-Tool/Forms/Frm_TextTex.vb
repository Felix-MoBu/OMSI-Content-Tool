...
Public Class Frm_TextTex
    ...
    Private Sub Frm_TextTex_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        LBMain.Items.Clear()
        For Each TTex In Frm_Main.actProj.model.TextTexturen
    ...
    Private Sub colorChanged()
        If manuelColorChange Then
            If LBMain.SelectedIndex >= 0 Then
                With Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex)
    ...
    Private Sub CBEnh_CheckedChanged(sender As Object, e As EventArgs) Handles CBEnh.CheckedChanged
        ...
        Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).enh = CBEnh.Checked
    End Sub
    ...
    Private Sub TBName_KeyUp(sender As Object, e As KeyEventArgs) Handles TBName.KeyUp
        Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).name = TBName.Text
    ...
    Private Sub TBFont_TextChanged(sender As Object, e As EventArgs) Handles TBFont.TextChanged
        Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).font = TBFont.Text
    End Sub

    Private Sub TBBreite_TextChanged(sender As Object, e As EventArgs) Handles TBBreite.TextChanged
        If sender.text <> "" Then
            Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).breite = TBBreite.Text
        End If
    End Sub

    Private Sub TBHoehe_TextChanged(sender As Object, e As EventArgs) Handles TBHoehe.TextChanged
        If sender.text <> "" Then
            Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).höhe = TBHoehe.Text
        End If
    End Sub

    Private Sub RBMono_Click(sender As Object, e As EventArgs) Handles RBMono.Click
        If RBMono.Checked Then
            Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).FontColorBool = False
        Else
            Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).FontColorBool = True
        End If
    End Sub
    ...
    Private Sub CBAusr_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBAusr.SelectedIndexChanged
        If LBMain.SelectedIndex >= 0 Then
            Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).orientation = CBAusr.SelectedIndex
        End If
    End Sub

    Private Sub CBGrid_CheckedChanged(sender As Object, e As EventArgs) Handles CBGrid.CheckedChanged
        Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex).grid = CBGrid.Checked
    End Sub
    ...
    Private Sub Frm_TextTex_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        With Frm_Main
            ...
            For Each TextTex In .actProj.model.TextTexturen
    ...
    Private Sub BTNeu_Click(sender As Object, e As EventArgs) Handles BTNeu.Click
        Dim NewTex As New OMSI_TextTexture
        With NewTex
            .name = "Neu"
            .index = Frm_Main.actProj.model.TextTexturen.Count
            .breite = 128
            .höhe = 128
        End With
        Frm_Main.actProj.model.TextTexturen.Add(NewTex)
    ...
    Private Sub BTEntfernen_Click(sender As Object, e As EventArgs) Handles BTEntfernen.Click
        If LBMain.SelectedIndex >= 0 Then
            ...
            Frm_Main.actProj.model.TextTexturen.Remove(Frm_Main.actProj.model.TextTexturen(LBMain.SelectedIndex + 1))
        End If
